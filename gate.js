...
(function(){
  ...
  function injectStyle(){
    ...
    #subGate p{font-size:12.5px;color:#8a8a8a;max-width:270px;line-height:1.7;margin:0;}
    #subGate .g-join{display:flex;align-items:center;gap:8px;padding:13px 28px;border-radius:12px;
      background:#2AABEE;color:#fff;text-decoration:none;font-size:14px;font-weight:800;margin-top:6px;}
    #subGate .g-status{font-size:12px;color:#7a7a7a;display:flex;align-items:center;gap:7px;margin-top:4px;}
  ...
  function showGate(link){
    ...
    gate.innerHTML =
      ...
      '<p>اشترك بقناة النادي على تيليجرام، وبمجرد ما تنضم بتدخل تلقائيًا بدون ما تسوي أي شي ثاني</p>' +
      '<a class="g-join" href="' + (link || 'https://t.me/') + '" target="_blank" rel="noopener">اشترك بالقناة الآن</a>' +
      '<div class="g-status"><span class="g-spin"></span><span>نتحقق من اشتراكك تلقائيًا...</span></div>';
