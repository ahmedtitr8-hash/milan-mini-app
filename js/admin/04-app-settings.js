async function saveAppSettings(){
  const payload = {
    ...
    ad_duration_seconds: Math.max(1, parseInt(document.getElementById('f_ad_duration_seconds').value, 10) || 15),
    ...
    banner_ad_enabled: document.getElementById('f_banner_ad_enabled').checked,
    banner_ad_image_url: document.getElementById('f_banner_ad_image_url').value.trim(),
    banner_ad_click_url: document.getElementById('f_banner_ad_click_url').value.trim(),
    banner_ad_network_script: document.getElementById('f_banner_ad_network_script').value.trim(),
    side_ad_enabled: document.getElementById('f_side_ad_enabled').checked,
    side_ad_interval_seconds: Math.max(60, (parseInt(document.getElementById('f_side_ad_interval_minutes').value, 10) || 20) * 60),
    side_ad_duration_seconds: Math.max(1, parseInt(document.getElementById('f_side_ad_duration_seconds').value, 10) || 20),
    side_ad_image_url: document.getElementById('f_side_ad_image_url').value.trim(),
    side_ad_click_url: document.getElementById('f_side_ad_click_url').value.trim(),
    side_ad_network_script: document.getElementById('f_side_ad_network_script').value.trim(),
  };
