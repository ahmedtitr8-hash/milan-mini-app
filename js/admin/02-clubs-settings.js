...
function enterClub(club){
  currentClub = club;
  sessionStorage.setItem('zoneClub', club);
...
async function loadAppSettings(){
  ...
  document.getElementById('f_ad_enabled').checked = !!(data && data.ad_enabled);
  document.getElementById('f_ad_image_url').value = (data && data.ad_image_url) || '';
  document.getElementById('f_ad_video_url').value = (data && data.ad_video_url) || '';
  document.getElementById('f_ad_click_url').value = (data && data.ad_click_url) || '';
  document.getElementById('f_ad_duration_seconds').value = (data && data.ad_duration_seconds) || 15;
  document.getElementById('f_ad_skip_after_seconds').value = (data && data.ad_skip_after_seconds != null) ? data.ad_skip_after_seconds : 5;
  document.getElementById('f_ad_network_script').value = (data && data.ad_network_script) || '';
  document.getElementById('f_banner_ad_enabled').checked = !!(data && data.banner_ad_enabled);
  document.getElementById('f_banner_ad_image_url').value = (data && data.banner_ad_image_url) || '';
  document.getElementById('f_banner_ad_click_url').value = (data && data.banner_ad_click_url) || '';
  document.getElementById('f_banner_ad_network_script').value = (data && data.banner_ad_network_script) || '';
  document.getElementById('f_side_ad_enabled').checked = !!(data && data.side_ad_enabled);
  document.getElementById('f_side_ad_interval_minutes').value = (data && data.side_ad_interval_seconds) ? Math.round(data.side_ad_interval_seconds/60) : 20;
  document.getElementById('f_side_ad_duration_seconds').value = (data && data.side_ad_duration_seconds != null) ? data.side_ad_duration_seconds : 20;
  document.getElementById('f_side_ad_image_url').value = (data && data.side_ad_image_url) || '';
  document.getElementById('f_side_ad_click_url').value = (data && data.side_ad_click_url) || '';
  document.getElementById('f_side_ad_network_script').value = (data && data.side_ad_network_script) || '';
}
