...
async function togglePIP(){
  ...
  }catch(e){ /* المتصفح رفض الطلب (مثلاً لازم يصير من تفاعل مستخدم مباشر) — نتجاهل بصمت */ }
}
...
(function initPIPButton(){
  ...
  if (btn){ if (pipSupported()) btn.classList.remove('hide'); else btn.classList.add('hide'); }
})();
