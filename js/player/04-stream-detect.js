...
// تجربة: تحويل مصادر Xtream/IPTV لبروكسي Cloudflare بدل Supabase (لتفادي استهلاك الـ egress).
// لو ما اشتغل، ارجع السطر التالي لقيمته الأصلية:
// const XTREAM_STREAM_PROXY = `https://ckriyvqnrzravknajckl.supabase.co/functions/v1/stream-proxy`;
const XTREAM_STREAM_PROXY = `https://milan-mini-app.ahmedtitr8.workers.dev`;
